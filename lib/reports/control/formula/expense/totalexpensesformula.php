...
/**
 * Class TotalExpensesFormula - класс формулы для перерасчета показателя Total Expenses.
 * @package makarenko\fincalc\reports\control\formula
 */
class TotalExpensesFormula extends BaseFormula {
    protected const PARAMETER_CODE = 40000;
